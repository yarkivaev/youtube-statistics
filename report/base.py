"""Base Report abstraction using decorator pattern."""
...
class Report(ABC):
    """Abstract base class for reports using decorator pattern.
    
    Each Report class wraps an object and provides an export() method
    ...
    def __getattr__(self, name):
        ...
        This makes the Report wrapper transparent, allowing direct
